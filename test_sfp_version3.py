...
from math import pi
from Datasets_U2 import RandomMove, unfold_image, concat_image, RandomMovePad, concat_enhanced_image
...
def main_worker(local_rank, nprocs, args):
    ...
    # 加载指定的checkpoint
    checkpoint = torch.load('./pt/U2net_withoutenhanced_best/914.pth')
